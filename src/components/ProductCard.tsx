...
export function ProductCard({ product, onAddToCart, onOpenDetails }: ProductCardProps) {
  ...
  return (
    ...
    >
      {/* Product Image */}
      <div className="relative overflow-hidden w-full aspect-[4/3] min-h-[200px] sm:min-h-[220px] bg-[#F4EDE2] flex items-center justify-center">
        <img
          ...
          onError={(e) => {
            ...
            e.currentTarget.src = imageAssets.jpg || imageAssets.webp || '/images/honey_sidr.jpg';
          }}
        />
