...
export const translations: Record<Language, TranslationDict> = {
  ar: {
    ...
    cooperativeName: 'تعاونية تدمامت - Coopérative Tadmamte',
    ...
    heroDesc: 'عسل طبيعي وأملو أركان فاخر بأيدي أسر منطقة سوس العريقة، نوفر لكم منتجات طبيعية خالصة وموثوقة بنسبة 100٪.',
    heroShopBtn: 'تسوق منتجاتنا',
    heroStoryBtn: 'تعرف على قصتنا',

    storyTitle: 'قصة تعاونية تدمامت - Coopérative Tadmamte',
    storySubtitle: 'أصالة وعراقة في الإنتاج من قلب منطقة سوس الأصيلة',
    storyP1: 'تعاونية تدمامت (Coopérative Tadmamte) ليست مجرد مشروع تجاري، بل هي حلم جماعي للأسر والنساء في قرى منطقة سوس العريقة. هنا، حيث تلتقي أصالة الأرض بجمالها، تجتمع نساؤنا وعضواتنا لنقل المعرفة المتوارثة جيلاً بعد جيل في إنتاج أخلص هدايا الأرض الطبيعية واحتراف عصر زيت الأركان وصناعة أملو الأصيل واستخلاص العسل بطرق صديقة للبيئة.',
    storyP2: 'مهمتنا واضحة وعميقة: إنتاج أفضل أنواع العسل الطبيعي وأملو الأركان الأصيل بأساليب طبيعية خالية تماماً من الإضافات الكيميائية، مع استخلاص العسل بطرق صديقة للبيئة تحترم النحل والطبيعة، وفي الوقت ذاته، توفير مصدر رزق كريم ومستدام للأسر القروية يحقق لهم الاستقلالية الاقتصادية ويدعم صمودهم وتشبثهم بقرى سوس المعطاء.',
    storyP3: 'كل منتج تشترونه منا هو مساهمة حقيقية ومباشرة في استمرار هذا الحلم، وضمان لتعليم أطفال القرى وتطوير البنية التحتية المحلية لتعاونية فلاحية تصنع الأمل من العسل.',
    storyCardTitle1: '100% طبيعي',
    storyCardDesc1: 'منتجات عضوية خالصة خالية من السكر المضاف والمواد الحافظة.',
    ...
    shopSubtitle: 'منتجات من ربوع سوس إليك مباشرة بمناحل ومزارع عضوية خالصة',
    catAll: 'الكل',
    catAmlou: 'أملو',
    catArgan: 'زيت أركان',
    catHoney: 'العسل',
    ...
    contactTitle: 'تواصل مع تعاونية تدمامت - Coopérative Tadmamte',
    ...
    contactSuccessDesc: 'تم استلام رسالتك بنجاح من قِبل إدارة تعاونية تدمامت - Coopérative Tadmamte. سنقوم بالرد عليك في أقرب فرصة ممكنة.',
