...
import { LayoutGrid, Filter, Star, Info, ShoppingCart, Check, ArrowDown, Leaf, Loader2 } from 'lucide-react';
import { useLanguage, getProductField } from './utils/translations';
import { isFirebaseConfigured, fetchProductsFromFirestore } from './utils/firebase';
...
export default function App() {
  ...
  useEffect(() => {
    try {
      localStorage.setItem('tifawin_products', JSON.stringify(allProducts));
    } catch (e) {
      console.error(e);
    }
  }, [allProducts]);
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            ...
            <div className="space-y-1">
              ...
              <span className="block text-xs text-gray-500 font-medium">
                {language === 'ar' ? 'مكونات برية طبيعية معقمة' : language === 'fr' ? 'Ingrédients sauvages et bio stérilisés' : '100% natural sterilized wild ingredients'}
              </span>
            </div>
