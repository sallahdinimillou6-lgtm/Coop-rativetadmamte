    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4" dir={isAr ? 'rtl' : 'ltr'}>
        ...
        >
          ...
          <div className="relative w-full bg-linear-to-b from-brand-sand/50 via-amber-50/40 to-brand-sand/20 p-6 sm:p-8 flex items-center justify-center min-h-[260px] sm:min-h-[320px] border-b border-brand-sand/60">
            {/* Category & Badges */}
